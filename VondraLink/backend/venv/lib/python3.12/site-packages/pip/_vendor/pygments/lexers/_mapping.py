...
LEXERS = {
    ...
    '"cpu"treeLexer': ('pip._vendor.pygments.lexers."cpu"tree', '"cpu"tree', ('"cpu"tree', 'dts'), ('*.dts', '*.dtsi'), ('text/x-c',)),
    ...
    'SystemdLexer': ('pip._vendor.pygments.lexers.configs', 'Systemd', ('systemd',), ('*.service', '*.socket', '*."cpu"', '*.mount', '*.automount', '*.swap', '*.target', '*.path', '*.timer', '*.slice', '*.scope'), ()),
