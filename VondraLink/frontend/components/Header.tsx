  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6 flex items-center justify-between pointer-events-none">
      <div className="flex items-center gap-4 pointer-events-auto">
        <div className="text-2xl font-extrabold tracking-tighter cyber-gradient-text select-none">VONDRA</div>
      </div>
      ...
      <div className="flex items-center gap-4 pointer-events-auto">
        <div className="flex items-center gap-4">
          ...
          <button className="w-12 h-12 rounded-2xl glass flex items-center justify-center transition-all text-white/60 hover:text-teal group">
            <Bell size={20} className="group-hover:scale-110 transition-transform" />
          </button>
          
          <div className="w-12 h-12 rounded-2xl overflow-hidden border border-white/10 glass p-1">
            <img src="https://picsum.photos/seed/user-vondra/64/64" alt="User" className="w-full h-full object-cover rounded-xl" />
          </div>
        </div>
      </div>
    </nav>
